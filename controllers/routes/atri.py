...
class Atri:
	def __init__(self, state: Any):
		...
		self.Radio1 = state["Radio1"]
		self.Radio2 = state["Radio2"]
		self.Radio3 = state["Radio3"]
		self.Radio4 = state["Radio4"]
		self.Radio5 = state["Radio5"]
		self._setter_access_tracker = {}
	...
	@property
	def Radio1(self):
		self._getter_access_tracker["Radio1"] = {}
		return self._Radio1
	@Radio1.setter
	def Radio1(self, new_state):
		self._setter_access_tracker["Radio1"] = {}
		global default_state
		self._Radio1 = Radio(new_state, default_state["Radio1"])

	@property
	def Radio2(self):
		self._getter_access_tracker["Radio2"] = {}
		return self._Radio2
	@Radio2.setter
	def Radio2(self, new_state):
		self._setter_access_tracker["Radio2"] = {}
		global default_state
		self._Radio2 = Radio(new_state, default_state["Radio2"])

	@property
	def Radio3(self):
		self._getter_access_tracker["Radio3"] = {}
		return self._Radio3
	@Radio3.setter
	def Radio3(self, new_state):
		self._setter_access_tracker["Radio3"] = {}
		global default_state
		self._Radio3 = Radio(new_state, default_state["Radio3"])

	@property
	def Radio4(self):
		self._getter_access_tracker["Radio4"] = {}
		return self._Radio4
	@Radio4.setter
	def Radio4(self, new_state):
		self._setter_access_tracker["Radio4"] = {}
		global default_state
		self._Radio4 = Radio(new_state, default_state["Radio4"])

	@property
	def Radio5(self):
		self._getter_access_tracker["Radio5"] = {}
		return self._Radio5
	@Radio5.setter
	def Radio5(self, new_state):
		self._setter_access_tracker["Radio5"] = {}
		global default_state
		self._Radio5 = Radio(new_state, default_state["Radio5"])
...
class RadiocustomClass:
	def __init__(self, state, def_state):
		...
		self.name: str = get_defined_value(state, def_state, "name")
		self.label: str = get_defined_value(state, def_state, "label")
		self.checked: bool = get_defined_value(state, def_state, "checked")
		self.radius: str = get_defined_value(state, def_state, "radius")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
...
class Radio:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onChange = False
		self.styles: RadiostylesClass = get_defined_value(state, def_state, "styles")
		self.custom: RadiocustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = RadiostylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = RadiocustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
